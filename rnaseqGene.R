######################################################
#intall rnaseqGene and associated packages through BiocManager::install("packagename")
...
#install.packages("~/Desktop/SPRING2020/BIO690/Genome_analysis_2020/tximeta_1.4.3.tar.gz", repos = NULL, type = "source")
